...
func (c *collection) addMovie(title1 string, genre1 string, year int, series1 bool) int{
	var id int
...
func(c *collection) editTitle(id int, index int, movie movies) string{
...
func(c *collection) editGenre(id int, index int, movie movies) string{
	scanner := bufio.NewScanner(os.Stdin)
...
func(c *collection) editYear(id int, index int, movie movies) int{
	var input string
	Message:
...
func(c *collection) editSeries(id int, index int, movie movies) bool{
	var input string
	Message:
...
func(c *collection) deleteMovie(id int, index int, movie movies) string{
	size := len(c.collection)
	...
	return "The movie at "+ strconv.Itoa(id)+ " has been deleted."
}
...
func addItem(c *collection) int{
	...
	return c.addMovie(title, genre, year, series)
}
